...
const Prescription = () => {
    ...
    return (
        <Layout>
            {addPrescription ? <AddPrescription setAddPrescription={setAddPrescription} /> :
                <div className='animate__animated animate__fadeIn animate__faster'>
                    <div className='flex justify-between items-center p-1'>
                        ...
                        <div className='font-medium mb-5 space-x-2'>
                            ...
                            <span className='md:text-lg text-rose-600'>Prescription</span>
                        </div>
                    </div>
                        ...
                        <table className='w-full min-w-[800px] text-[17px]'>
                            <caption className='bg-white p-4 rounded-t-lg '>
                                <div className='flex items-center justify-between'>
                                    <div className='text-xl md:text-2xl font-bold text-[#006a60]'>Prescription List</div>
                                    <button
                            ...
                            <tbody>
                                <tr className='bg-[#dcdfe9] text-left'>
                                    ...
                                    <th className='py-3 md:text-lg'>Date</th>
                                    <th className='py-3 md:text-lg text-center'>Actions</th>
                                </tr>

                                {prescription.map((items, index) => (
