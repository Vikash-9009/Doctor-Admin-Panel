        ...
        <Layout>
            <div className='animate__animated animate__fadeIn animate__faster'>
                <div className='flex justify-end items-center font-medium mb-5 p-1 gap-2'>
                    ...
                    <span className='md:text-lg text-rose-600'>Device</span>
                </div>

                <div className='overflow-scroll'>
                    <table className='w-full min-w-[600px] text-[17px]'>
                        <caption className='bg-white p-4 rounded-t-lg'>
                            <div className='flex items-center justify-between'>
                                <div className='text-xl md:text-2xl font-bold text-[#006a60]'>Device</div>
                                <button
