            ...
            <div>
                <div className='flex justify-between items-center p-1'>
                    ...
                    <div className='font-medium mb-5 space-x-2'>
                        ...
                        <span className='text-lg text-rose-600'>Patient Case Studies List</span>
                    </div>
                </div>
                ...
                <table className='w-full text-[17px]'>
                    <caption className='bg-white p-4 rounded-t-lg '>
                        <div className='flex items-center justify-between'>
                            <div className='text-2xl font-bold text-[#006a60]'>Patient Case Studies List</div>
                    ...
                    <tbody>
                        <tr className='bg-[#dcdfe9] text-left'>
                            <th className='py-3 ps-4 text-lg'>Name</th>
                            <th className='py-3 text-lg'>Email</th>
                            <th className='py-3 text-lg'>Phone</th>
                            <th className='py-3 text-lg'>Food Allergy</th>
                            <th className='py-3 text-lg'>Heart Disease</th>
                            <th className='py-3 text-lg'>Diabetic</th>
