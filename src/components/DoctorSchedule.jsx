        ...
        <Layout>
            <div className='animate__animated animate__fadeIn animate__faster'>
                <div className='flex justify-end items-center font-medium mb-5 p-1 gap-2'>
                    ...
                    <span className='md:text-lg text-rose-600'>Doctor Schedule</span>
                </div>

                <div className='overflow-scroll'>
                    <table className='w-full min-w-[800px] text-[17px]'>
                        <caption className='bg-white p-4 rounded-t-lg text-xl md:text-2xl font-bold text-[#006a60]'>
                            Doctor Schedule
                        </caption>
                        ...
                        <tbody>
                            <tr className='bg-[#dcdfe9] text-left'>
                                ...
                                <th className='py-3 md:text-lg'>Weakdays</th>
                                <th className='py-3 md:text-lg'>Visiting Time</th>
