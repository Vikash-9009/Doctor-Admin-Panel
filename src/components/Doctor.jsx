        ...
        <Layout>
            <div className='animate__animated animate__fadeIn animate__faster'>
                <div className='flex justify-between items-center p-1'>
                    <span className='text-2xl md:text-4xl font-bold pb-3'>
                        Doctors List
                    </span>
                    <div className='font-medium space-x-2'>
                        <Link to='/dashboard' className='md:text-lg hover:text-red-600 duration-200' >Dashboard</Link>
                        <i className="fa-solid fa-chevron-right"></i>
                        <span className='md:text-lg text-rose-600'>Doctors List</span>
                    </div>
                </div>
                    ...
                    <table className='w-full min-w-[800px] text-[17px]'>
                        <caption className='bg-white p-4 rounded-t-lg '>
                            <div className='flex items-center justify-between'>
                                <div className='text-xl md:text-2xl font-bold text-[#006a60]'>Doctors List</div>
                        ...
                        <tbody>
                            <tr className='bg-[#dcdfe9] text-left'>
                                ...
                                <th className='py-3 md:text-lg'>Name</th>
                                <th className='py-3 md:text-lg'>Email</th>
                                <th className='py-3 md:text-lg'>Phone Control</th>
                                <th className='py-3 md:text-lg'>Department</th>
                                <th className='py-3 md:text-lg'>Status</th>
